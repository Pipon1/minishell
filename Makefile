...
$(NAME): $(OBJS)
	@$(CC) $(CFLAGS) $(OBJS) -g -o $(NAME) -lreadline -L /Users/hefurrer/.brew/opt/readline/lib -I /Users/hefurrer/.brew/opt/readline/include/readline -Llibft/ -lftprintf
